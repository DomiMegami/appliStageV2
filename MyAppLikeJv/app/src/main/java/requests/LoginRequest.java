...
public class LoginRequest extends StringRequest {
    ...
    private static final String LOGIN_REQUEST_URL = "http://sd-67292.dedibox.fr/~dominique.d/Login.php";
    //Créer une Map :
    ...
    //constructeur :
    public LoginRequest( String user_pseudo, String user_mdp, Response.Listener<String> listener){
